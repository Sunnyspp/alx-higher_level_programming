...
# with lists we can refer to group of data with 1 name

# Each item in the lust corresponds to a number (index)
# Just like how people have identification numbers,
# By default the 1st item in a list has the index 09

# [0 : "string"] [1 : 1.234] [2 : 28] [3 : "c"]

# Python lists can grow in soze and can contain data
# of any type
...
# an awesome thing about list is that you can use many
...
# Find out how many item is in at the list
